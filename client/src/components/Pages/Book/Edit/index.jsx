...
const Edit = () => {
  ...
  const handleSubmit = async event => {
    ...
    Axios.post(`${globalStore.REACT_APP_ENDPOINT}/booking/update`,  
    {
        _id: bookings._id,
   ...
   .then(resp => {
      ...
      console.log(resp);
        setNotification({
          type: "success",
          message: "This update was performed successfully."
        });
      ...
      .catch(error => {
        ...
        setNotification({
          type: "danger",
          message: "Couldn't update at this time."
        });
  ...
  return (
    bookings ? (
      <>
        <Header title="Edit your booking"> </Header>
