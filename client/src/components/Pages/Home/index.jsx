...
import {Container, Carousel, Image, Col,Card,Row}  from 'react-bootstrap';
       ...
       {/* Content */}
      	<Row >
		        <Col lg="true">
					<Card class="card rounded-0 border-0 shadow-sm mb-5 mb-lg-0">
						<div class="card-img-container position-relative">
							<Image src="Image/dog.jpg"  width="400"   height="300" class="card-img-top rounded-0"/>

						</div>
						<div class="card-body pb-0">
							<h4 class="card-title text-truncate text-center mb-0"><a href="#">Pets</a></h4>
						</div>
		        ...
		        <Col class="col-12 col-lg-4">
					<Card class="card rounded-0 border-0 shadow-sm mb-5 mb-lg-0">
						<div class="card-img-container position-relative">
							<Image  src="Image/groming.jpg"   width="400"   height="300"  class="card-img-top rounded-0" />
						
							
						</div>
						<div class="card-body pb-0">
							<h4 class="card-title text-truncate text-center mb-0"><a href="#">Services</a></h4>
						</div>
		        ...
		        <Col class="col-12 col-lg-4">
					<Card class="card rounded-0 border-0 shadow-sm mb-5 mb-lg-0">
						<div class="card-img-container position-relative">
							<Image src="Image/visa.jpg"   width="400"   height="300"  class="card-img-top rounded-0" />
							
						</div>
						<div class="card-body pb-0">
							<h4 class="card-title text-truncate text-center mb-0"><a href="#">Payments</a></h4>
						</div>
